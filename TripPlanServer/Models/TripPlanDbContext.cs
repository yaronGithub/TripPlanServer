...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Categori__19093A0B387B8388");
        });

        modelBuilder.Entity<Picture>(entity =>
        {
            entity.HasKey(e => e.PicId).HasName("PK__Pictures__B04A93C1754E7C34");
        ...
        {
            entity.HasKey(e => e.PlaceId).HasName("PK__Places__D5222B6E2089FAF6");
        ...
        {
            entity.HasKey(e => e.PlanId).HasName("PK__PlanGrou__755C22B75E8C61DD");
        ...
        {
            entity.HasKey(e => e.ReviewId).HasName("PK__Reviews__74BC79CE0B2A601F");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CC4C238EB381");
